...
<body>
    <div class="container mt-5 mx-10">
        <h2 style="font-family: Georgia, 'Times New Roman', Times, serif;">Form Nilai Ujian</h2>
        <hr>
<form method="post" action="">
  ...
  <div class="form-group row">
    <label for="mk" class="col-3 col-form-label">Pilih Mata Kuliah</label> 
    <div class="col-8">
      <select id="matkul" name="matkul" class="custom-select" required="required">
        <option>Data Warehouse</option>
        <option>Data Analis</option>
  ...
  <div class="form-group row">
    ...
    <input type="submit" name="proses" class="btn btn-warning" value="Simpan">
    </div>
  </div>
</form>
<br>
